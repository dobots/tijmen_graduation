...
t_mpc = np.transpose(np.array([t_mpc[292:2315]])-t_mpc[292])
x_mpc = x_mpc[292:2315]
y_mpc = y_mpc[292:2315]
z_mpc = z_mpc[292:2315]
x_rot_mpc = x_rot_mpc[292:2315]
y_rot_mpc = y_rot_mpc[292:2315]
z_rot_mpc = z_rot_mpc[292:2315]
x_vel_mpc = x_vel_mpc[292:2315]
y_vel_mpc = y_vel_mpc[292:2315]
z_vel_mpc = z_vel_mpc[292:2315]
...
print(f'completion_time pid : {t_pid[-1]-t_pid[0]}')
